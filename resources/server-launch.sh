...
# Broadcast Server Info with custom address
apt-get install -y avahi-daemon avahi-utils


## Download Latest Server File Version
echo "Checking latest version of plutonium please wait..."
...
# Download the Server Config Files
...
# Apply specific configs from environment variables [WIP]
...
#     sed -i -e "/\/\/Classic\/TranZit Maps rotation/ {
#         n; s/^\(.*\)$/\/\/\1/; n; a\
#         $SERVER_MAP_ROTATION
#     }" "$CFG_PATH"
...
# IW4Admin CONFIGURATION

LOGS_DIR="$PLUTONIUM_DIRECTORY/storage/t6/logs/"

echo "Checking IW4Admin files..."

echo "Downloading latest version of IW4Admin please wait..."
